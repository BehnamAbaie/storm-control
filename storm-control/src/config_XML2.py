...
######## main settings ##########
#################################
listCh = [['DAPI','1.0',True],['A488','1.0',True],['Cy3','1.0',True],['Cy5','1.0',False],['A750','1.0',False]]
# Nz = 10
# zstep = 1.0
...
for ii in range(Nz):
    ...
    if listCh[0][2]:
        ...
        ET.SubElement(event, "off").text = str(float(shutter_counter+1.0+ii*Nch))
