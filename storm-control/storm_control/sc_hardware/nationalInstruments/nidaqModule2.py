    ...
    def __init__(self, module_params = None, qt_settings = None, **kwds):
        ...
        for fn_name in configuration.getAttrs():
            ...
            for task_name in task.getAttrs():
                ...
                print('test is here')
                print(task_name)
                print(task_params.get("source").split('/')[1])
                self.clkSource = task_params.get("source").split('/')[1]
    ...
    def filmTiming(self, message):
        ...
        if self.run_shutters:
            ...
            if (self.oversampling == 1):
                print('test is here2')
                print("camera_fire_pin"+"_"+self.clkSource) 
                wv_clock = self.timing.get("camera_fire_pin"+"_"+self.clkSource)
            else:
