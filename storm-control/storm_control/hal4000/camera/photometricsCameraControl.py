...
class PhotometricsCameraControl(cameraControl.HWCameraControl):
    ...
    def __init__(self, config = None, is_master = False, **kwds):
        ...
        #tempRx = 70;
        #tempRy = 70;
        #self.parameters.setv("x_start", 1024-tempRx)
        #self.parameters.setv("y_start", 1024-tempRy)
        #self.parameters.setv("x_end", 1024+tempRx-1)
        #self.parameters.setv("y_end", 1024+tempRy-1)
